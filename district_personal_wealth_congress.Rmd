...
summary(lm(log(cd_median_income) ~ q1 + q5, cel_acs_os)) #wealthiest members come from slightly wealthier areas q5 has 2% higher median income. There's no difference for q1.  
